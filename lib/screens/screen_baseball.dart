...
class _BaseballScreenState extends State<BaseballScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      ...
      final double heightMargin = screenHeight * 0.01;
              ...
              : Column(children: [
                  Container(
                    margin: EdgeInsets.fromLTRB(
                        0, heightMargin * 2, 0, heightMargin),
                  ...
                  Container(
                    margin:
                        EdgeInsets.fromLTRB(0, heightMargin, 0, heightMargin),
                    decoration: BoxDecoration(
                        color: Colors.white,
                        borderRadius: BorderRadius.circular(15)),
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(
                        0, heightMargin, 0, heightMargin * 2),
                    decoration: BoxDecoration(
                        color: Colors.white,
                        borderRadius: BorderRadius.circular(15)),
